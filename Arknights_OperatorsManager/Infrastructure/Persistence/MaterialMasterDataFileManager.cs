...
/// <summary>
/// 素材マスターデータのFileManager（GitHub同期対応）
/// </summary>
public class MaterialMasterDataFileManager : FileManagerBase<MaterialMasterData>
{
    private const string FileName = "material_master_data.json";
    ...
    public MaterialMasterDataFileManager(
        ILogger<MaterialMasterDataFileManager> logger,
        EventAggregator? eventAggregator = null)
        : base(new JsonFileSerializer<MaterialMasterData>(), logger, eventAggregator)
    {
    ...
    protected override GitHubFileOptions? ConfigureGitHubOptions()
    {
        ...
        return new GitHubFileOptions
        {
            ...
            Branch = "main",
            FilePath = "data/material_master_data.json",
