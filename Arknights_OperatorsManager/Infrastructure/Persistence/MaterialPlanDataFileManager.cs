...
/// 素材計画データのFileManager
/// </summary>
public class MaterialPlanDataFileManager : FileManagerBase<MaterialPlanData>
{
    private const string FileName = "material_plan_data.json";
    ...
    public MaterialPlanDataFileManager(
        ILogger<MaterialPlanDataFileManager> logger,
        EventAggregator? eventAggregator = null)
        : base(new JsonFileSerializer<MaterialPlanData>(), logger, eventAggregator)
    {
